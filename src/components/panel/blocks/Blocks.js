...
const Blocks = ({ number_data }) => {
    ...
    const content_blocks = [
        ...
        {
            type: 0, title: "Интервал", value: (number_data.number_data.random_interval
                ? (number_data.number_data.range_interval[0] + " - " + number_data.number_data.range_interval[1])
                : number_data.number_data.interval)
                + " минут"
        },
        { type: 1, title: "Сообщения", value: getQuintityMessages() + " из 4" },
        { type: 2, title: "Автоответчик", value: "", param: number_data.number_data.answerphone },
        { type: 3, title: "Упомянания", value: "ы", param: number_data.number_data.mention },
        { type: 4, title: "Рандом интервалов", value: "", param: number_data.number_data.random_interval },
        { type: 5, title: "Рандом сообщений", value: "", param: number_data.number_data.random_messages },
